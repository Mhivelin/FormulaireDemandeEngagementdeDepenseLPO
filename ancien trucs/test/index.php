...
<body>
    <div class="container">
        ...
        <form id="monFormulaire" action="index.php" method="POST" enctype="multipart/form-data">
    ...
    <div id="pdf">
        <h1>Lorem ipsum</h1>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas quasi odit enim iure quos nihil doloribus
            exercitationem eum consectetur saepe quae facilis quia architecto id, recusandae, fugiat ducimus, culpa
            voluptatem.</p>
